...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel( 2, R.drawable.ic_eggs));
        allCategoryModelList.add(new AllCategoryModel( 3, R.drawable.ic_fruits));
        allCategoryModelList.add(new AllCategoryModel( 4, R.drawable.ic_juice));
        allCategoryModelList.add(new AllCategoryModel( 5, R.drawable.ic_cupcake));
        allCategoryModelList.add(new AllCategoryModel( 6, R.drawable.ic_cookies));
        allCategoryModelList.add(new AllCategoryModel( 7, R.drawable.ic_meat));
        allCategoryModelList.add(new AllCategoryModel( 8, R.drawable.ic_salad));
        allCategoryModelList.add(new AllCategoryModel( 9, R.drawable.ic_vegetables));
    ...
    //we need some decoration class for manage spacing
